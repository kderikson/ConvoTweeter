...
from convotweeterfunctions import *
...
todays_date = RetrieveTodaysDate()

# Get the first speaker
curr_speaker = soup.h1.next_sibling.next_sibling
print curr_speaker

curr_speaker = curr_speaker.next_sibling.next_sibling
newpost = ComposeTweet(curr_speaker, todays_date);
...
curr_speaker = curr_speaker.next_sibling.next_sibling
while NotFound(curr_speaker, todays_date):
